...
class TestErrorCases:
    ...
    def test_kafka_details_http_error(self, client):
        ...
        with requests_mock.Mocker() as m:
            ...
            with pytest.raises(ValueError, match="Failed to fetch Kafka details"):
    ...
    def test_kafka_details_request_exception(self, client):
        ...
        with requests_mock.Mocker() as m:
            ...
            with pytest.raises(ValueError, match="An error occurred while fetching Kafka details"):
                client.get_kafka_details()
    ...
    def test_system_status_http_error(self, client):
        ...
        with requests_mock.Mocker() as m:
            ...
            with pytest.raises(ValueError, match="Failed to fetch system status"):
    ...
    def test_system_metrics_request_exception(self, client):
        ...
        with requests_mock.Mocker() as m:
            ...
            with pytest.raises(ValueError, match="An error occurred while fetching system metrics"):
    ...
    def test_jupyter_details_http_error(self, client):
        ...
        with requests_mock.Mocker() as m:
            ...
            with pytest.raises(ValueError, match="Failed to fetch Jupyter details"):
    ...
    def test_register_service_server_not_configured(self, client):
        ...
        with requests_mock.Mocker() as m:
            ...
            with pytest.raises(ValueError, match="Server is not configured or unreachable"):

...
class TestAPIClientSearch:
    ...
    def test_search_datasets_http_error(self, client):
        ...
        with requests_mock.Mocker() as m:
            ...
            with pytest.raises(ValueError, match="Error searching for datasets: Search failed"):
    ...
    def test_search_datasets_http_error_no_detail(self, client):
        ...
        with requests_mock.Mocker() as m:
            ...
            with pytest.raises(ValueError, match="Error searching for datasets"):
                client.search_datasets(terms=["test"])
    ...
    def test_advanced_search_http_error(self, client):
        ...
        with requests_mock.Mocker() as m:
            ...
            with pytest.raises(ValueError, match="Error in advanced search: Advanced search failed"):
